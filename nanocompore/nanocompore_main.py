...
def main(args=None):
    ...
    parser_sr_common.add_argument("--not_bound", action='store_true', default=False, help="If given, the values generated by the distributions will be released from the min and max observed values bounds from the model file (default: %(default)s)")

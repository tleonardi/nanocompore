...
def main(args=None):
    ...
    parser_sc_sample_yaml.add_argument("--sample_yaml", default=None, type=str, metavar="sample_yaml",
    ...
    parser_sc_sample_args.add_argument("--file_list1", default=None, type=str, metavar="/path/to/Condition1_rep1,/path/to/Codition1_rep2",
        help="Comma separated list of NanopolishComp files for label 1. (required if --sample_yaml not given)")
    parser_sc_sample_args.add_argument("--file_list2", default=None, type=str, metavar="/path/to/Condition2_rep1,/path/to/Codition2_rep2",
    ...
    parser_sc_io.add_argument("--outpath", "-o", type=str, default="./",
        help="Path to the output folder (default: %(default)s)")
    parser_sc_io.add_argument("--outprefix", "-p", type=str, default="out",
    ...
    parser_sc_filtering.add_argument("--min_coverage", type=int, default=50,
        help="Minimum coverage required in each condition to do the comparison (default: %(default)s)")
    parser_sc_filtering.add_argument("--downsample_high_coverage", type=int, default=None,
    ...
    parser_sc_testing.add_argument("--sequence_context", type=int, default=2, choices=range(0,5),
    ...
    parser_sc_common.add_argument("--nthreads", "-n", type=int, default=3,
    ...
    parser_sr_io.add_argument("--run_type", type=str, default="RNA",
    ...
    parser_sr_io.add_argument("--overwrite", action='store_true', default=False,
        help="Use --outpath even if it exists already (default: %(default)s)")
    parser_sr_io.add_argument("--nreads_per_ref", type=int, default=100,
    ...
    parser_sr_modify.add_argument("--mod_bases_freq", type=float, default=0,
        help="Frequency of bases to modify in each read (if possible) (default: %(default)s)")
    parser_sr_modify.add_argument("--mod_bases_type", type=str, default="A",
...
def sampcomp_main(args):
    ...
    if args.sample_yaml:
        eventalign_fn_dict = args.eventalign_fn_dict
...
def build_eventalign_fn_dict(file_list1, file_list2, label1, label2):
    ...
    """
    eventalign_fn_dict = OrderedDict()
    eventalign_fn_dict[lab1] = {"{}_{}".format(lab1, i): v for i, v in enumerate(file1.split(","),1)}
    eventalign_fn_dict[lab2] = {"{}_{}".format(lab2, i): v for i, v in enumerate(file2.split(","),1)}

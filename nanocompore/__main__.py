...
def main():
    ...
    parser_ec_in.add_argument("--sample", "-s", required=True, help="Unique identifier of the sample")
    parser_ec_in.add_argument("--condition", "-c", required=True, help="Condition label for the sample")
    ...
    parser_ec_out.add_argument("--subdirs", "-d", default=100, type=int,
                               help="Number of subdirectories to split output files into")
...
def eventalign_collapse_main(args):
    ...
    e = Eventalign_collapse(eventalign_path = args.input,
